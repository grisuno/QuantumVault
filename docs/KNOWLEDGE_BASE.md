...
- `H` (line 162)
- `Hint` (line 166)
- `deriveKeyFromPassphrase` (line 178) - *Derive a 256-bit key from a passphrase with a caller-chosen PBKDF2 iteration count. This is the single PBKDF2 implementation in the client; deriveM...*
...
- `postJson` (line 467)
- `buildRegistration` (line 490) - *Build the zero-knowledge registration payload entirely in the browser.  Returns `{ payload, recoveryCode }`: `payload` is the JSON body to POST to ...*
- `register` (line 524)
...
**Classes:**
- `_ListLogHandler` (line 82) `class _ListLogHandler` - *Collect emitted log messages in a list for assertions.*
