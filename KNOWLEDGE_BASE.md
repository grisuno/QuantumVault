...
> Generated offline by **readmenator**. 78 files, 588 symbols, 419 imports. Supports C, C++, Python, Go, Rust, JS/TS, Java, C#, Shell, PHP, Dart, GDScript, Nim, ASM, Ruby, Swift, Kotlin, Scala, Lua, Elixir.
> No LLMs. No tokens. Pure static analysis. See more [here](https://github.com/grisuno/ReadMenator)

**Start here:** Statistics Dashboard for scope, God Nodes for blast radius, Architecture Reference for per-file API. Agents: prefer `readmenator-agent/INDEX.md` + `SYMBOLS.md`.

**Total Files Parsed:** 78 | **Total Symbols Extracted:** 588 | **Total Imports:** 419
 | **Resolved Imports:** 101
...
| 2 | `qv-crypto.js` | 0.1594 | 0.1759 | 0.1759 | 0.00 | 0.45 |
| 3 | `user.py` | 0.1231 | 0.0412 | 0.0412 | 0.00 | 0.96 |
| 4 | `security.py` | 0.1230 | 0.0508 | 0.0508 | 0.00 | 0.90 |
| 5 | `register.js` | 0.1199 | 0.0819 | 0.0819 | 0.00 | 0.67 |
| 6 | `facade.py` | 0.1113 | 0.0233 | 0.0233 | 0.00 | 0.96 |
| 7 | `contact.py` | 0.1111 | 0.0170 | 0.0170 | 0.00 | 1.00 |
| 8 | `mailer.py` | 0.1103 | 0.0159 | 0.0159 | 0.00 | 1.00 |
| 9 | `deniable_vault.py` | 0.1102 | 0.0157 | 0.0157 | 0.00 | 1.00 |
| 10 | `plans.py` | 0.1100 | 0.0153 | 0.0153 | 0.00 | 1.00 |
...
|------|-------|-------------|----------|
| `app_factory.py` | 46.8 | | 0.0000 |
| `utils.py` | 30.8 | | 0.0000 |
| `user.py` | 30.7 | | 0.0412 |
| `auth.py` | 24.9 | | 0.0000 |
| `security.py` | 19.0 | | 0.0508 |
| `admin.py` | 17.1 | | 0.0000 |
| `qv-crypto.js` | 16.0 | | 0.1759 |
| `facade.py` | 14.6 | | 0.0233 |
| `auth.py` | 13.4 | | 0.0000 |
...
- `contact.py` <-> `deniable_vault.py` (5 hops, across 3 communities)
- `contact.py` <-> `deniable_vault.py` (4 hops, across 3 communities)
- `deniable_vault.py` <-> `contact.py` (4 hops, across 3 communities)
...
- What does app_factory.py depend on, and what depends on it? (23 connections)
- What does utils.py depend on, and what depends on it? (15 connections)
- What does user.py depend on, and what depends on it? (14 connections)
- How are the 34 files in 'views' related to each other?
- Why are contact.py and deniable_vault.py connected through 5 hops across 3 communities?
...
| `user.py` | 0.491 | 0.100 | 0.256 | 27 | 21 |
| `security.py` | 0.182 | 0.114 | 0.141 | 10 | 24 |
| `register.js` | 0.054 | 0.152 | 0.113 | 3 | 32 |
| `facade.py` | 0.473 | 0.071 | 0.232 | 26 | 15 |
...
| `test_facade.py` | 0.946 | 0.048 | 0.407 | 52 | 10 |
| `test_cover.py` | 0.946 | 0.033 | 0.398 | 52 | 7 |
| `auth.py` | 0.527 | 0.133 | 0.291 | 29 | 28 |
| `account.js` | 0.164 | 0.281 | 0.234 | 9 | 59 |
...
| `facade.py` | 5 | 5 | 10 |
| `message.py` | 1 | 8 | 9 |
| `superadmin_audit.py` | 1 | 8 | 9 |

---

## Architecture Violations

Violations of architectural layer rules detected in the import graph. **17 strict violations, 0 warnings.**
...
| `test_srp.py` | testing | `utils.py` | presentation | testing must not import presentation | strict |
| `test_utils.py` | testing | `utils.py` | presentation | testing must not import presentation | strict |
...
| `RM001` | info | Large number of functions in py: 438 total | py | 438 |
...
| `RM005` | info | Print statement found (consider logging instead) | python | 63 |
...
- `__init__.py` (0 symbols, no doc)
- `test_account_facade.py` (6 symbols, no doc)
- `test_cover.py` (52 symbols, no doc)
- `test_security.py` (8 symbols, no doc)
- `test_utils.py` (3 symbols, no doc)
- `__init__.py` (0 symbols, no doc)
- `__init__.py` (0 symbols, no doc)
- *... and 1 more*
...
graph TD
    ...
    views_auth_py -- resolved_imports --> utils_utils_py
    views_facade_py -- resolved_imports --> controllers_facade_py
    views_faq_py -- resolved_imports --> models_plans_py
    views_faq_py -- resolved_imports --> utils_utils_py
    ...
    views_subscription_py -- resolved_imports --> utils_utils_py
    ...
    views_views_py -- resolved_imports --> utils_utils_py
    ext_os["os"]
    class ext_os ext;
...
classDiagram
  ...
  class mutation_test_py_Mutation {
    <<class>>
    +_is_equivalent_bool(tokens, index)
    +discover_mutations(path, source)
    +apply_mutation(source, mutation)
    +collect(targets, limit)
    +purge_bytecode()
    +run_suite(python, tests)
    +main(argv)
  }
...
**Classes:**
- `MessageController` (line 16) `class MessageController` - *Handles message persistence in the zero-knowledge flow.*

**Methods:**
- `__init__` (line 19) `def __init__(self, users_path, users_db_path)` - *Initialize the controller.
...
- `send_encrypted_message` (line 33) `def send_encrypted_message(self, sender, recipient, encrypted_message_b64, cek_for_recipient, cek_for_sender)` - *Persist an opaque message envelope for the recipient.
...
- `get_messages` (line 75) `def get_messages(self, username, page, per_page)` - *Return opaque message envelopes for the user.
...
**Classes:**
- `UserEditForm` (line 24) `class UserEditForm(FlaskForm)` - *Form for editing user details.
...
- `PlanForm` (line 57) `class PlanForm(FlaskForm)` - *Form for creating or editing a subscription plan.*

**Methods:**
- `admin` (line 69) `def admin()` - *Plan catalog read view.
...
rotation) is the superadmin panel's job and lives at
``/superadmin<token>``.*
- `superadmin_edit_user` (line 91) `def superadmin_edit_user(username)` - *Full profile edit for a single user.
...
- `manage_plans` (line 196) `def manage_plans()` - *Handle plan management.*
- `edit_plan` (line 220) `def edit_plan(plan_name)` - *Handle editing of plan details.*
- `superadmin` (line 256) `def superadmin()` - *Superadmin identity-recovery and inventory panel.
...
attacker could trigger a reset by luring a superadmin to follow a
crafted link.*
- `superadmin_reset_mfa` (line 343) `def superadmin_reset_mfa(username)` - *Disable MFA and clear the pending code for ``username``.

Used when a user loses their authenticator device. We do NOT
touch the password, the email, or the KEM material — losing a
second factor should not invalidate the rest of the identity.*
- `superadmin_resend_confirmation` (line 391) `def superadmin_resend_confirmation(username)` - *Issue a fresh ``confirmation_token`` for ``username``.

The token's 24h expiry is recomputed by ``update_user`` (see
models/user.py:337). If the user already verified, we still issue
a new token so the link can be reused as a magic-link login path
— useful when a user has lost access to their primary device.*
- `superadmin_toggle_suspend` (line 439) `def superadmin_toggle_suspend(username)` - *Flip ``subscription_status`` between active and inactive.

Suspension is a billing/operational lever (refuse new uploads,
block new devices) that does not require touching the KEM
material. Reactivation brings the user back into the same
position they were in before suspension.*
- `admin_contacts` (line 490) `def admin_contacts()`
